...
<!-- Vietnamese Section Header -->
<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=rect&color=gradient&customColorList=12,16,20&height=3&section=header"/>
</div>
...
**✨ Đóng gói Stable Release**
- ✅ Đổi numbering schema: v8.x → v1.0.0 (initial public release)
- ✅ Self-hosted 100% trên repo ekaznyra/NguyenNgocAnhTu
...
- ✅ Snow, Meitu XiuXiu, Widgetsmith, Funimate, Unfold
- ✅ WPS Office, Xmind, Caixin, Caixin Weekly, LiuLiShuo Reading
- ✅ Nicegram (3 endpoint hooks), SoundCloud Go+

**🧹 Dọn dẹp + Chất lượng**
- ✅ Gỡ các script dead-endpoint: Mojo (api.mojo-app.com), Reface (api.reface.video)
...
<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=rect&color=gradient&customColorList=24,25,20&height=3&section=header"/>
</div>
