...
const spotifyJson = {
    "options": {
        "java_package": "com.smile.spotify.model"
    },
    "nested": {
        "BootstrapResponse": {
            "oneofs": {
                "ucsResponse": {
                    "oneof": ["ucsResponseV0", "trialsFacadeResponseV1"]
                }
            },
            "fields": {
                "ucsResponseV0": {
        ...
        "UcsResponse": {
            "oneofs": {
                "resolveResult": {
                    "oneof": ["resolveSuccess", "resolveError"]
                },
        ...
        "AssignedValue": {
            "oneofs": {
                "structuredValue": {
                    "oneof": ["boolValue", "intValue", "enumValue"]
                }
            },
            "fields": {
                "propertyId": {
        ...
        "AccountAttribute": {
            "oneofs": {
                "value": {
                    "oneof": ["boolValue", "longValue", "stringValue"]
                }
            },
            "fields": {
                "boolValue": {
